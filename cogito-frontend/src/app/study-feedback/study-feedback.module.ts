...
@NgModule({
    declarations: [StudyFeedbackComponent, StudyStartComponent, DemographicsComponent, Task1_1Component, UeqComponent, MiscNotesComponent, ThanksComponent, Task2x1Component, Task3x1Component, Task4x1Component, Task5x1Component],
    exports: [
